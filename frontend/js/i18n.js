...
const HorusI18n = (() => {
  ...
  const translations = {
    ...
    // -- Email notifications
    'settings.email': { hr: 'Email notifikacije — nova sonda', en: 'Email notifications — new sonde',
    ...
    'settings.email_hint': { hr: 'Šalje email kad se detektira nova sonda u zraku (prvi paket).', en: 'Sends email when a new sonde is detected in the air (first packet).',
    ...
    pl: 'Cooldown (godziny)' },
    'settings.cooldown_hint': { hr: 'Min. razmak između emailova za istu sondu', en: 'Min. interval between emails for the same sonde',
